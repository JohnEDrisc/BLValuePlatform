...
export const UI_STRINGS: Record<string, Record<string, string>> = {
  EN: {
    ...
    // --- MISSING CALCULATOR LABELS FIXED HERE ---
    ...
    numGeographicRegions: 'Geographic Regions',
    ...
    annualCloseOvertimeHours: 'Annual Close Overtime (Hrs)',
    avgTimeToFillPosition: 'Time to Fill Position (Months)',
    costToReplaceResourcePct: 'Cost to Replace (%)',
    financialCloseCycleDays: 'Close Cycle (Days)',
    reconciliationsPerMonth: 'Recs Per Month',
    journalEntriesPerMonth: 'Journals Per Month',
    accountsReconciledPct: 'Accounts Reconciled (%)',
    currentDso: 'Current DSO (Days)',
    priorRestatements: 'Prior Restatements',
    materialWeakness: 'Material Weakness',
    priorFines: 'Prior Fines ($)',
    manualProcessPct: 'Manual Process (%)',
    acquisitionsPerYear: 'Acquisitions / Year',
    avgDealSize: 'Avg Deal Size ($)',
    integrationCostPerDeal: 'Integration Cost / Deal ($)',
    integrationTimeMonths: 'Integration Time (Months)',
    expectedReturnOnMaPct: 'Expected Return on M&A (%)',
    keyTalentRetentionTarget: 'Retention Target (%)',
    historicTurnoverMaPct: 'Historic M&A Turnover (%)',
    investmentPeriod: 'Investment Period (Yrs)',
    costSoftwareYear1: 'Software Cost Year 1',
    costSoftwareYear2: 'Software Cost Year 2',
    costSoftwareYear3: 'Software Cost Year 3',
    costSoftwareYear4: 'Software Cost Year 4',
    costSoftwareYear5: 'Software Cost Year 5',
    costServicesYear1: 'Services Cost Year 1',
    costServicesYear2: 'Services Cost Year 2',
    costServicesYear3: 'Services Cost Year 3',
    costServicesYear4: 'Services Cost Year 4',
    costServicesYear5: 'Services Cost Year 5',
    year1RampPct: 'Year 1 Ramp (%)',
